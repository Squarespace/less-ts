// JavaLadderProbe - compiles every .less file in a dir with a wired
// context (function table active, so value-position calls evaluate) at
// a fixed compat level and pins byte-exact outputs.
//
...
//
// Usage: java -cp "<classpath>" JavaLadderProbe <less-dir> <out-dir> <level>
//
...
//   javac -proc:none -cp "$CP" -d /tmp JavaLadderProbe.java
//   java -cp "/tmp:$CP" JavaLadderProbe <less-dir> levels/java-ladder/<level> <level>
